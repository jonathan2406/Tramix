    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4 relative">
      <div className="max-w-md w-full tramix-glass tramix-card rounded-[2rem] p-10 relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-brand-primary-dark tracking-tight">{t.register.title}</h1>
        </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-6 max-w-lg w-full">
              ...
              <button
                ...
                className="w-full tramix-btn-primary text-white font-bold py-4 rounded-2xl hover:-translate-y-0.5 transition-all"
              >
