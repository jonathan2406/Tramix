    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-bg p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-white/80 backdrop-blur-md rounded-[2rem] shadow-2xl shadow-brand-primary/5 p-10 border border-white relative z-10">
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <span className="text-xs text-center text-gray-500 uppercase">{t.login.orWith}</span>
          <span className="border-b w-1/5 lg:w-1/4"></span>
        </div>
        ...
        <p className="mt-10 text-center text-sm text-slate-500 font-medium">
          {t.login.noAccount}{" "}
          <a href="/register" className="text-brand-primary font-bold hover:text-brand-secondary transition-colors underline underline-offset-4 decoration-2 decoration-brand-secondary/30 hover:decoration-brand-secondary">
